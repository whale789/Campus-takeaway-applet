...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    b: common_vendor.o(common_vendor.m(($event) => $data.account = $event, {
      number: true
    }, true)),
    c: common_vendor.p({
      trim: "all",
    ...
    i: common_vendor.o((...args) => $options.FindBackPsd && $options.FindBackPsd(...args)),
    ...
    l: common_vendor.sr("message", "29ab876e-2"),
    m: common_vendor.p({
      type: "message"
    })
  });
}
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "D:/uni-app/YTU-Takeaway-Manage/pages/ManagerLogin/ManagerLogin.vue"]]);
