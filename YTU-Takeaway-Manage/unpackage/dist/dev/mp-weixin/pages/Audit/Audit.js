  ...
  return {
    a: common_vendor.f($data.ListAudit, (item, index, i0) => {
      return {
        ...
        d: common_vendor.t(item.AuditMain),
        ...
        h: common_vendor.o(($event) => $options.AuditDetail(item._id))
      };
    })
  };
}
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "D:/uni-app/YTU-Takeaway-Manage/pages/Audit/Audit.vue"]]);
