...
function populateParameters(fromRes, toRes) {
  ...
  const parameters = {
    appId: "__UNI__87F635D",
    appName: "YTU-Takeaway-Manage",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
const pages = [
  {
    ...
    style: {
      navigationBarTitleText: "YTU-TA-用户管理",
  ...
  },
  {
    ...
    style: {
      navigationBarTitleText: "YTU-TA-信息审核",
      enablePullDownRefresh: false
    }
  },
  {
    ...
    style: {
      navigationBarTitleText: "YTU-TA-学生反馈",
      enablePullDownRefresh: false
    }
  },
  {
    ...
    style: {
      navigationBarTitleText: "YTU-TA-个人信息",
      enablePullDownRefresh: false,
  ...
  {
    path: "pages/ManagerLogin/ManagerLogin",
    style: {
  ...
  {
    path: "pages/Recoverpsd/Recoverpsd",
    style: {
      navigationBarTitleText: "",
      enablePullDownRefresh: false
    }
  ...
  {
    path: "pages/AddManager/AddManager",
    style: {
      navigationBarTitleText: "",
      enablePullDownRefresh: false
    }
  ...
  list: [
    {
      ...
      text: "用户管理",
      iconPath: "/static/images/UserManage.png",
      selectedIconPath: "/static/images/UserManage-active.png"
    },
    {
      pagePath: "pages/Audit/Audit",
      text: "信息审核",
      iconPath: "/static/images/InformationAudit.png",
      selectedIconPath: "/static/images/InformationAudit-actvie.png"
    },
    {
      pagePath: "pages/Feedback/Feedback",
      text: "学生反馈",
      iconPath: "/static/images/Studentfeedback.png",
      selectedIconPath: "/static/images/Studentfeedback-active.png"
    },
    {
      pagePath: "pages/Personal/Personal",
      text: "个人信息",
      iconPath: "/static/images/PersonalMsg.png",
      selectedIconPath: "/static/images/PersonalMsg-active.png"
    }
  ]
};
const t = {
...
const k = true, I = "mp-weixin", C = b([]), A = I, P = b('{\n    "address": [\n        "127.0.0.1",\n        "10.20.134.253"\n    ],\n    "debugPort": 9000,\n    "initialLaunchType": "local",\n    "servePort": 7000,\n    "skipFiles": [\n        "<node_internals>/**",\n        "E:/HBuilderX/plugins/unicloud/**/*.js"\n    ]\n}\n'), E = b('[{"provider":"aliyun","spaceName":"ytu-takeaway","spaceId":"mp-15be003a-e292-4e97-86ed-f0163836fd3d","clientSecret":"lxaF31tf73amUhKAS6Dklg==","endpoint":"https://api.next.bspapp.com"}]') || [];
let x = "";
try {
  x = "__UNI__87F635D";
} catch (e2) {
