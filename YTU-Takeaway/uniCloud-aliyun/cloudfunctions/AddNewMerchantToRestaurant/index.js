...
exports.main = async (event, context) => {
	...
	let ClassID = y + m + d + h + minute + second + Math.random().toString(36).substr(2);
	// let ClassID=event.GoodsClass.ClassID;
	// let GoodsId=event.GoodsClass.GoodsDetail.GoodsId;
	// 	{
	// 		ClassID:ClassId,
	// 		ClassName:"默认",
	// 		GoodsDetail:[
